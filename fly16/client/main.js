...
let lieu = "à la salle des fêtes de Fives (Lille)"
...
let textArray = [
  ...
  //4
  () => `Je vous invite à venir remettre votre titre en jeu, si vous l'osez, le ${date} ${lieu}.`,
]
...
initializeSvg = function () {
  ...
  const toHide = ["scribb", "buttonbot", "buttontop", "buttontop", "light", "clicsamuel", "clicresas", "clicamicale", "color", "chyMAP", "chyDATE"]
